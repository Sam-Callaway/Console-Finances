...
//Just loop through the array calculating profit change and if it is greater than the current greatest figure then overwrite that figure. And also overwrite the month at the same time.
...
//same code as above essentially just "change <" instead of "change > so we're looking for lowest number not highest" 
for (i=1; i < finances.length; i++)
{
var change = finances[i][1] - finances[i-1][1];
